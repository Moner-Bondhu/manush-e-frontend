  ...
  <ion-page class="h-full">
    ...
    <ion-content class="h-full overflow-auto">
      <ion-toolbar class="">
        <ion-buttons slot="end">
          <ion-button
            router-link="/choice"
            fill="clear"
            class="text-lg font-semibold tracking-normal text-[#FF3D3D] px-2"
          >
            <svg
      ...
      <section id="profile-details" class="flex h-auto px-5">
        <div class="flex items-center rounded-lg w-full">
          <img
            src="/profile.png"
            alt="User Avatar"
            class="w-20 h-20 rounded-full shrink-0 mr-3"
          />
      ...
      <section class="flex flex-col pt-5">
        ...
        <div
          class="relative flex overflow-x-auto py-2 scrollbar-hidden scroll-section"
        >
          <!-- Cards Container -->
          <div :style="cardsContainerStyle" class="flex">
            <!-- Card 1 -->
            <ion-card
              @click="navigateToLink('/task1')"
              class="min-w-[200px] max-w-[250px] cursor-pointer shadow-lg rounded-lg"
            >
              <ion-img
          ...
          >
            ...
            <div :style="cardsContainerStyle" class="flex">
              ...
              >
                ...
                <ion-card-header class="pt-2 pb-0">
                  <ion-card-title class="text-sm font-semibold"
                    >উদ্বিগ্নতা</ion-card-title
                  >
                </ion-card-header>
                <ion-card-content class="py-2">
                  <p class="text-sm font-regular text-gray-600">
                    উদ্বিগ্ন লাগছে? পড় এই ব্লগটি
                  </p>
                </ion-card-content>
              </ion-card>
      ...
      <section class="flex flex-col pt-4">
        ...
        <div class="grid grid-cols-3 gap-4 px-5 py-4">
          <!-- Quick Option 1 -->
          <div
            class="flex flex-col justify-center bg-white p-2 gap-2 rounded-lg shadow-md"
          >
            <ion-icon
              name="help-circle"
              class="text-4xl mb-2 place-self-center"
            ></ion-icon>
