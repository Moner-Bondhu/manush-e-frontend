      ...
      <section class="flex flex-col w-full items-center justify-center p-2">
        <div class="p-4 w-full">
          <h2 class="text-3xl font-semibold text-center">
            <span class="text-red-600">মানুষ-ই</span> তে স্বাগতম
          </h2>
          <ion-img src="/intro.png" class="mx-auto my-8"></ion-img>

          <div class="">
            <p class="text-md font-regular text-center">
              <span class="text-red-600">লগইন</span> করতে আপনার ফোন নাম্বার দিন
            </p>
            <form @submit.prevent="handleSubmit" class="flex flex-col mt-4">
              <div
                class="flex relative w-full h-8 bg-gray-300 rounded justify-end"
              >
                <img
                ...
                />
                <span
                  class="absolute left-10 top-1/2 transform -translate-y-1/2 text-sm font-poppins-regular text-gray-700"
                  >+88</span
                >
                <input
                  v-model="phoneNumber"
